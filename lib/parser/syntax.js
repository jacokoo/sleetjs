...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c84 = function(start, c) {return c.length > 0},
      peg$c85 = function(start, c, pair) { return pair },
      peg$c86 = peg$otherExpectation("Attribute pair"),
      peg$c87 = function(ns, key) {
              return new ast.Attribute(ns, key, [], location())
          },
      peg$c88 = function(ns, key, v) {return v},
      peg$c89 = function(ns, key, value) {
      ...
      peg$c92 = peg$otherExpectation("Attribute setting"),
      peg$c93 = "&",
      ...
      peg$c99 = function(name, c) { return c },
      peg$c100 = function(name, attrs) {
              return new ast.Setting(name, attrs, location())
          },
      peg$c101 = function(start, n) { return n},
      peg$c102 = peg$otherExpectation("Attribute value"),
      peg$c103 = function(name, attributes) {
              return new ast.Helper(name, attributes, location())
          },
      peg$c104 = function(start, c, v) {return v},
      peg$c105 = function(start, rest) {
              rest.unshift(start)
              return rest
          },
      ...
      peg$c108 = function(value, c) { return c },
      peg$c109 = function(value, ts, end) { return ts.length || end },
      peg$c110 = function(value, ts, end) {
              return new ast.TransformValue(value.value, ts, end, location())
          },
      peg$c111 = function(name, first, v) {return v},
      peg$c112 = function(name, first, rest) {
              rest.unshift(first)
      ...
      peg$c115 = function(s) { return new ast.StringValue(s, location()) },
      peg$c116 = function(n) { return new ast.NumberValue(n, location()) },
      peg$c117 = function(b) { return new ast.BooleanValue(b, location()) },
      peg$c118 = "null",
      peg$c119 = peg$literalExpectation("null", false),
      peg$c120 = function() { return new ast.NullValue(location()) },
      peg$c121 = function(i) { return new ast.IdentifierValue(i, location()) },
      peg$c122 = /^[.\/]/,
      peg$c123 = peg$classExpectation([".", "/"], false, false),
      peg$c124 = function(p, s) {
          return new ast.IdentifierValue(p + s, location())
      },
      peg$c125 = peg$otherExpectation("Compare Operator"),
      peg$c126 = "==",
      ...
      peg$c139 = peg$otherExpectation("Blank line"),
      peg$c140 = peg$otherExpectation("Identifier"),
      peg$c141 = function(i, c) {
              c.unshift(i)
              return c.join('')
          },
      peg$c142 = "[",
      ...
      peg$c147 = function(ii) {
              return `['${ii}']`
          },
      peg$c148 = /^[a-zA-Z$@_]/,
      peg$c149 = peg$classExpectation([["a", "z"], ["A", "Z"], "$", "@", "_"], false, false),
      peg$c150 = /^[a-zA-Z0-9$_\-]/,
      peg$c151 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "$", "_", "-"], false, false),
      peg$c152 = function(start, rest) {
              return start + rest
          },
      ...
      peg$c165 = "\x0B",
      peg$c166 = peg$literalExpectation("\x0B", false),
      peg$c167 = "\f",
      peg$c168 = peg$literalExpectation("\f", false),
      peg$c169 = peg$otherExpectation("Indents"),
      peg$c170 = function(spaces) {
              if (IDT_TOK === null) IDT_TOK = spaces
              return spaces.length % IDT_TOK.length === 0
          },
      peg$c171 = function(spaces) {
              return spaces.length / IDT_TOK.length
          },
      peg$c172 = function(tabs) {
              if (IDT_TOK === null) IDT_TOK = '\t'
              return IDT_TOK === '\t'
          },
      peg$c173 = function(tabs) {
              return tabs.length
          },
      peg$c174 = peg$otherExpectation("Quoted string"),
      peg$c175 = "\"",
      peg$c176 = peg$literalExpectation("\"", false),
      peg$c177 = function(chars) { return chars },
      peg$c178 = "'",
      peg$c179 = peg$literalExpectation("'", false),
      peg$c180 = peg$otherExpectation("Double quoted string char"),
      peg$c181 = function() { return text() },
      peg$c182 = function(char) { return char },
      peg$c183 = peg$otherExpectation("Single quoted string char"),
      peg$c184 = peg$otherExpectation("Escaped char"),
      peg$c185 = "0",
      peg$c186 = peg$literalExpectation("0", false),
      peg$c187 = /^[0-9]/,
      peg$c188 = peg$classExpectation([["0", "9"]], false, false),
      peg$c189 = function() { return '\0' },
      peg$c190 = /^[nfrt]/,
      peg$c191 = peg$classExpectation(["n", "f", "r", "t"], false, false),
      peg$c192 = function(c) { return '\\' + c },
      peg$c193 = "b",
      peg$c194 = peg$literalExpectation("b", false),
      peg$c195 = function() { return '\x0B' },
      ...
      peg$c203 = peg$otherExpectation("Number"),
      peg$c204 = /^[+\-]/,
      peg$c205 = peg$classExpectation(["+", "-"], false, false),
      peg$c206 = function(sign, n) {
              return sign === '-' ? -n : n
          },
      peg$c207 = "0x",
      peg$c208 = peg$literalExpectation("0x", true),
      peg$c209 = /^[0-9a-f]/i,
      peg$c210 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true),
      peg$c211 = function() {
      ...
      peg$c218 = "e",
      peg$c219 = peg$literalExpectation("e", true),
